...
url_mongo = getenv('MONGO_URL')                                                                                                   #URL de la base de datos MongoBD (No lleva puerto)
puerto_mongo = int(getenv('MONGO_PORT'))                                                                                                           #Puerto para establecer conexion con MongoDB
db_mongo = getenv('MONGO_DB')                                                                                                             #Nombre de la base de datos en MongoDB     
collection_mongo = getenv('MONGO_COLLECTION')                                                                                          #Nombre de la coleccion en el db de MongoDB
user_mongo = getenv('MONGO_USER')
pass_mongo = getenv('MONGO_PASS')

#Credenciales InfluxDB
url_influx = getenv('INFLUX_URL')                                                                                      #URL de la base de datos InfluxDB (Si lleva puerto)         
token_influx = getenv('INFLUX_TOKEN')                                                                              #Token para establecer conexion con InfluxDB
org_influx = getenv('INFLUX_ORG')                                                                                                          #Org del bucket en InfluxDB
bucket1_influx = getenv('BUCKET1')                                                                                           #Bucket1 al que se quiere establecer conexion en Influx
bucket2_influx = getenv('BUCKET2')                                                                                                   #Bucket2 al que se quiere establecer conexion en Influx
